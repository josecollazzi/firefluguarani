...
// copied from .pub-cache/hosted/pub.dev/firebase_ui_localizations-1.9.0/lib/src/lang/es.dart
class FirebaseuiLocalizationGn extends FirebaseUILocalizations<FirebaseUILocalizationLabels> {
  const FirebaseuiLocalizationGn(super.locale, super.labels);
